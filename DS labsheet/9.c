//program to test validity of arguement using truth table
#include <stdio.h>
int main()
{
    char truthtable[9][8];
    ...
    for(i=1;i<9;i++)
    {
        if(truthtable[i][5] == 'T' && truthtable[i][6] == 'T' || truthtable[i][5] == 'F' && truthtable[i][6] == 'F')
            truthtable[i][7] = 'T';
        else
            truthtable[i][7] = 'F';
    }
    ...
    if(i==9)
        printf("This is valid arguement");
    else
        printf("This is invalid arguement");
